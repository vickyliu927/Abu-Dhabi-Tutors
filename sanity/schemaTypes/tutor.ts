...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'url',
      description: 'Link for the "Hire a Tutor" button. For subject pages, use /{slug}#contact-form format (e.g., "/online-abu-dhabi-english-tutor#contact-form"). For homepage, use "/#contact-form"',
      validation: (Rule: any) => Rule.required(),
    }),
    defineField({
      name: 'profilePDF',
